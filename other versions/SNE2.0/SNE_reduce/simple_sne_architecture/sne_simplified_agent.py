...
from sne_simplified_core import SimpleWorkingMemory, SimpleAttentionManager, SimpleIntentionGenerator, SimpleMetaCognitiveMonitor
...
class SimpleSmartNeuralExplorer:
    ...
    def select_action(self, state: np.ndarray) -> np.ndarray:
        ...
        selected_intention = self._select_best_intention(intentions)
